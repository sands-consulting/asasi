...
class EvaluationSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $evaluationTypeData = [
            ['name' => 'Commercial', 'notes' => 'Please enter all commercial submission details.', 'price' => 1],
            ['name' => 'Technical', 'notes' => 'Please enter all technical submission details', 'period' => 1],
        ];
