...
<div class="page-title">
    <h4>{{ trans('submissions.views.index.title') }}</h4>
</div>
<div class="heading-elements">
    {{-- <div class="heading-btn-group">
        <a href="{{ route('admin.submissions.create') }}" class="btn btn-link btn-float text-size-small has-text legitRipple">
            <i class=" icon-user-plus"></i> <span>{{ trans('submissions.buttons.create') }}</span>
        </a>
    </div> --}}
</div>
@endsection
