	...
	<table class="table table-bordered table-striped">
		...
		<tbody>
			<tr v-for="(employee, index) in employees">
				<td>@{{ index + 1}}</td>
				<td><input type="text" v-bind:name="'employees[' + index + '][name]'" class="form-control" v-model="employee.name"></td>
				<td><input type="text" v-bind:name="'employees[' + index + '][designation]'" class="form-control" v-model="employee.designation"></td>
				<td>
					<select v-bind:name="'employees[' + index + '][role]'" class="form-control" v-model="employee.role">
				...
				<td>
					<select v-bind:name="'employees[' + index + '][nationality_id]'" class="form-control" v-model="employee.nationality_id">
				...
				<td>
					...
					<input type="hidden" v-bind:name="'employees[' + index + '][id]'" class="form-control" v-model="employee.id">
				</td>
			</tr>
			<tr>
