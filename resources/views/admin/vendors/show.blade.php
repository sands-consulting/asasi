...
<div class="panel panel-flat">
    ...
    {!! Former::open_vertical(action('Admin\VendorsController@approve', $vendor->id))->method('PUT') !!}
        <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="form-control-static">{{{ $vendor->country or 'No Country' }}}</div>
                        </div>
                    </div>
                </div>
            </fieldset>
            ...
            <div class="text-right">
                {!! Former::submit(trans('vendors.buttons.edit'))
                    ->addClass('btn-default')
                    ->formaction(route('admin.vendors.edit', $vendor->id)) !!}

                {!! Former::submit(trans('vendors.buttons.approve'))
                    ->addClass('btn-primary')
                    ->formaction(route('admin.vendors.approve', $vendor->id)) !!}
            </div>
        </div>
    {!! Former::close() !!}
</div>
