...
<div class="heading-elements">
	<div class="heading-btn-group">
		...
		<a href="{{ route('admin.users.activate', $user->id) }}" data-method="PUT" class="btn btn-link btn-float text-size-small has-text text-warning legitRipple">
			<i class="icon-user-lock"></i> <span>{{ trans('user.buttons.assume') }}</span>
		</a>
		@endif
