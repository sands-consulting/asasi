        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {!! app('menu')->handler('gateways.panel-buttons.revisions')->render('inline') !!}
                    <h4>
                        {{trans('gateways.view_revisions', ['name' => $gateway->name])}}
                    </h4>
                </div>
                <div class="panel-body">

                    <dl class="timeline">
                    @foreach($gateway->revisionHistory->reverse() as $history)
                        @if($history->key == 'created_at' && !$history->old_value)
                            ...
                            <dd>{{trans('gateways.created_this')}}</dd>
                        @else
                            ...
                            <dd>{{trans('gateways.changed_from_to', [
