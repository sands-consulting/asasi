<div role="tabpanel" class="tab-pane" id="tab-notice-award">
	{!! Former::open(route('admin.notices.award', $notice->id))->novalidate()->addClass('panel panel-flat') !!}
		...
		<div class="panel-body">
			{!! Former::select('submission_id')->label('notices.views.admin.show.award.submission')->options($notice->submissions()->whereStatus('submitted')->get())->placeholder('notices.views.admin.show.award.select-submission')->required() !!}
