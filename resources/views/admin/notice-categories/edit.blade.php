...
<div class="page-title">
    <h4>
        ...
        <span class="text-semibold">{{ trans('notice-categories.views.edit.title') }}</span>
    </h4>
</div>
...
<div class="panel panel-flat">
    <div class="panel-body">
        {!! Former::open(route('admin.notice-categories.show', $noticeCategory->id))->method('PUT') !!}
            {!! Former::populate($noticeCategory) !!}
