        ...
        <div class="sidebar-category sidebar-category-visible mt-10">
            ...
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li class="active"><a href="{{ route('dashboard.index') }}"><i class="icon-home4"></i> <span>All</span></a></li>
                    <li><a href="{{ route('dashboard.eligible') }}"><i class="icon-home4"></i> <span>Eligibles</span><span class="label bg-blue-400">2</span></a></li>
                    <li><a href="{{ route('dashboard.purchased') }}"><i class="icon-home4"></i> <span>Purchased</span></a></li>
                    <li><a href="{{ route('dashboard.limited') }}"><i class="icon-home4"></i> <span>Limited</span></a></li>
                </ul>
            </div>
        </div>
        <!-- /main navigation -->
